package com.nulllab.blutooth.test;
...
import com.nulllab.blutooth.adapter.BleDeviceListAdapter;
import com.nulllab.blutooth.utils.Utils;
import com.nulllab.blutooth.test.R;
    ...
    private void checkPermission() {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            if (ContextCompat.checkSelfPermission(this,
                ...
                per = false;
                ActivityCompat.requestPermissions(this,
                        new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 33);
            }
